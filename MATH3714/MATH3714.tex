...
\includegraphics{MATH3714_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\includegraphics{MATH3714_files/figure-latex/unnamed-chunk-6-1.pdf}
...
\begin{example}
The random vector~\(Y\) in \eqref{eq:lmstat0} has
\begin{equation*}
    \mathbb{E}(Y)_i
    = \mathbb{E}(Y_i)
...
\begin{lemma}
Let \(Z\in\mathbb{R}^n\) be a random vector, \(A\in\mathbb{R}^{m\times n}\) a matrix
...
\includegraphics{MATH3714_files/figure-latex/unnamed-chunk-26-1.pdf}
\end{example}
...
\includegraphics{MATH3714_files/figure-latex/unnamed-chunk-27-1.pdf}
...
\includegraphics{MATH3714_files/figure-latex/unnamed-chunk-28-1.pdf}

...
\def\labelenumi{\arabic{enumi})}
\item
  \(\frac{1}{\sigma^2} \varepsilon^\top H \varepsilon\sim \chi^2_{p+1}\)
\item
  \(\frac{1}{\sigma^2} \varepsilon^\top (I - H) \varepsilon\sim \chi^2_{n - p - 1}\)
\item
...
and thus is \(\chi^2_{p+1}\) distributed. This completes the proof of the
first statement.
...
\begin{equation}
  ...
  \sim \chi^2_{n - p - 1}.  \label{eq:sigma-hat-chi-squared}
\end{equation}
Since the expectation of a \(\chi^2_r\) distribution equals \(r\), we find
\begin{equation*}

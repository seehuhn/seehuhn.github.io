...
estimartes the regression coefficients by minimizing the residual sum of
squares:
\begin{align*}
  r(\beta)
...
to a simple, simulated data set. Since the operator \texttt{\^{}} has a special
...
\includegraphics{MATH5714M_files/figure-latex/unnamed-chunk-17-1.pdf}
...
\includegraphics{MATH5714M_files/figure-latex/unnamed-chunk-20-1.pdf}
...
\includegraphics{MATH5714M_files/figure-latex/unnamed-chunk-21-1.pdf}

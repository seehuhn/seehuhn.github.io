...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{MATH5714M_files/figure-latex/hist-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{MATH5714M_files/figure-latex/broken-hist-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{MATH5714M_files/figure-latex/buffalo1-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{MATH5714M_files/figure-latex/buffalo2-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{MATH5714M_files/figure-latex/snow-hist-col-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{MATH5714M_files/figure-latex/snow-dens-col-1.pdf}}
...
\addcontentsline{toc}{section}{Interlude: Kernel Density Estimation in R}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{MATH5714M_files/figure-latex/snow-dens-col2-1.pdf}}
...
\addcontentsline{toc}{subsection}{Speed Improvements}
...
##  KDE1 1399.043 1463.4745 1520.3156 1484.3230 1502.8960 6729.453  1000
##  KDE2  197.989  254.8560  331.4757  263.0355  269.7595 9097.326  1000
##  KDE3  179.703  220.5595  304.0049  226.2175  232.7980 5714.457  1000
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{KDE.builtin }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(x.tilde, x, K, h) \{}
    \FunctionTok{density}\NormalTok{(x,}
      \AttributeTok{kernel =}\NormalTok{ K, }\AttributeTok{bw =}\NormalTok{ h }\SpecialCharTok{/} \FunctionTok{sqrt}\NormalTok{(}\DecValTok{6}\NormalTok{),}
...
## Unit: microseconds
##     expr     min       lq     mean   median      uq     max neval
##  density 157.399 168.8175 186.2054 172.6715 176.997 3759.29  1000
\end{verbatim}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.5100}}
...
\bottomrule\noalign{}
\endlastfoot
Uniform & \includegraphics[width=4cm,height=\textheight,keepaspectratio]{MATH5714M_files/figure-html/kUniform-1.pdf} & \(\displaystyle\frac13\) & \(\displaystyle\frac12\) & \(0.08333\) \\
Triangular & \includegraphics[width=4cm,height=\textheight,keepaspectratio]{MATH5714M_files/figure-html/kTriangular-1.pdf} & \(\displaystyle\frac16\) & \(\displaystyle\frac23\) & \(0.07407\) \\
Epanechnikov & \includegraphics[width=4cm,height=\textheight,keepaspectratio]{MATH5714M_files/figure-html/kEpanechnikov-1.pdf} & \(\displaystyle\frac15\) & \(\displaystyle\frac35\) & \(0.07200\) \\
Gaussian & \includegraphics[width=4cm,height=\textheight,keepaspectratio]{MATH5714M_files/figure-html/kGaussian-1.pdf} & \(1\) & \(\displaystyle\frac{1}{2\sqrt{\pi}}\) & \(0.07958\) \\
\end{longtable}
